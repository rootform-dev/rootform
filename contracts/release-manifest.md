...
- release-set manifest SHA-256 binding RF Vocabulary and every supplied Dialect
  at their own versions and digests;
...
Runtime inventory includes the RF Vocabulary and supplied Dialects at their
exact MPL-2.0 identifiers and digests from the release-set manifest, the Go
runtime at its exact BSD-3-Clause toolchain version, plus every incorporated
