...
resource "azurerm_servicebus_queue" "claims_review_priority" {
  name                                    = "claims-review-priority"
  namespace_id                            = azurerm_servicebus_namespace.prod.id
...
resource "azurerm_eventgrid_event_subscription" "claims_submitted_intake" {
